...
(1, 'تويتا', 'Toyta', '16746642573014034218947_image.jpg', '2022-10-08 20:05:45', '2023-01-25 14:30:57'),
...
(1, 'سؤال', 'question', 'اجابه منطقية', 'answer', '2023-02-01 13:32:31', '2023-02-01 13:35:19'),
(3, 'سؤال تاني', 'question', 'اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه  اجابه', 'answer answer answer answer answer answer answer answer answer answer answer answer answer answer answer answer answer answer', '2023-02-01 13:56:38', '2023-02-01 13:56:38');
...
CREATE TABLE `countries` (
  ...
  `ar_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `en_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ar_info` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `en_info` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `countries` (`id`, `ar_name`, `en_name`, `ar_info`, `en_info`, `created_at`, `updated_at`) VALUES
(1, 'مصر', 'egypt', '', '', '2023-02-22 21:13:05', NULL),
(2, 'السعودية', 'sudia', NULL, NULL, '2023-02-22 20:41:24', '2023-02-22 20:41:24');
...
CREATE TABLE `items_infos` (
  ...
  `quotation_order_id` bigint(20) UNSIGNED DEFAULT NULL,
...
INSERT INTO `items_infos` (`id`, `user_id`, `part_number`, `brand_id`, `quotation_order_id`, `ar_part_name`, `en_part_name`, `ar_part_description`, `en_part_description`, `offered_stock`, `min_quantity_per_transaction`, `max_quantity_per_transaction`, `unit_of_packing`, `quantity_per_pallet`, `width`, `length`, `thickness`, `created_at`, `updated_at`) VALUES
(1, 4, '200', 1, 1, 'تيست', 'test', 'وصف', 'info', 10, 2, 8, 20, 10, 20, 30, 50, NULL, NULL),
(5, 4, '30', 1, 2, 'قطعه', 'part', 'وصف', 'info', 2000, 100, 2000, 10, 50, 100, 200, 300, '2022-12-13 14:07:35', '2022-12-13 14:07:35'),
(14, 4, '11-22-33-44', 1, 34, 'قطعه', 'part', 'وصف', 'info', 2000, 100, 2000, 10, 50, 100, 200, 300, '2022-12-22 21:01:17', '2022-12-22 21:01:17'),
(15, 4, '44-11-aa-gg-33', 1, 34, 'قطعه', 'part', 'وصف', 'info', 2000, 100, 2000, 10, 50, 100, 200, 300, '2022-12-22 21:01:17', '2022-12-22 21:01:17'),
(21, 4, '11-22-33-44', 1, 42, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2022-12-27 15:15:14', '2022-12-27 15:15:14'),
(22, 4, '44-11-aa-gg-33', 1, 42, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2022-12-27 15:15:14', '2022-12-27 15:15:14'),
(23, 4, '11-22-33-44', 1, 49, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-01-11 15:57:34', '2023-01-11 15:57:34'),
(24, 4, '44-11-aa-gg-33', 1, 49, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-01-11 15:57:34', '2023-01-11 15:57:34'),
(25, 4, '11-22-33-44', 1, 50, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-01-11 16:21:26', '2023-01-11 16:21:26'),
(26, 4, '44-11-aa-gg-33', 1, 50, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-01-11 16:21:26', '2023-01-11 16:21:26'),
(31, 13, '11-22-33-44', 1, 55, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(32, 13, '44-11-aa-gg-33', 1, 55, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(35, 13, '11-22-33-44', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(36, 13, '44-11-aa-gg-33', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(37, 3, '11-22-33-44', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(38, 3, '44-11-aa-gg-33', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(39, 4, '11-22-33-44', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(40, 4, '44-11-aa-gg-33', 1, 56, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(41, 4, '11-22-33-44', 1, NULL, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(42, 4, '44-11-aa-gg-33', 1, NULL, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(43, 4, '11-22-33-44', 1, NULL, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-26 05:24:15', '2023-02-26 05:24:15'),
(44, 4, '44-11-aa-gg-33', 1, NULL, 'قطعه', 'part', 'وصف', 'info', 2000, 10, 2000, 10, 50, 100, 200, 300, '2023-02-26 05:24:15', '2023-02-26 05:24:15');
...
(61, 31, 10, 100, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(62, 31, 50, 80, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(63, 32, 10, 100, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(64, 32, 50, 80, '2023-02-24 14:21:10', '2023-02-24 14:21:10'),
(69, 35, 10, 100, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(70, 35, 50, 80, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(71, 36, 10, 100, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(72, 36, 50, 80, '2023-02-25 04:23:07', '2023-02-25 04:23:07'),
(73, 37, 10, 100, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(74, 37, 50, 80, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(75, 38, 10, 100, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(76, 38, 50, 80, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(77, 39, 10, 100, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(78, 39, 50, 80, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(79, 40, 10, 100, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(80, 40, 50, 80, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(81, 41, 10, 100, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(82, 41, 50, 80, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(83, 42, 10, 100, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(84, 42, 50, 80, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(85, 43, 10, 100, '2023-02-26 05:24:15', '2023-02-26 05:24:15'),
(86, 43, 50, 80, '2023-02-26 05:24:15', '2023-02-26 05:24:15'),
(87, 44, 10, 100, '2023-02-26 05:24:15', '2023-02-26 05:24:15'),
(88, 44, 50, 80, '2023-02-26 05:24:15', '2023-02-26 05:24:15');
...
(23, '2023_01_30_203538_create_users_privillages_table', 8),
(24, '2023_02_01_005115_create_common_questions_table', 9),
(25, '2023_02_06_203748_create_countries_table', 10),
(26, '2023_02_23_224100_create_vendors_requests_table', 11),
(27, '2023_02_26_044717_create_offers_table', 12),
(28, '2023_02_26_050611_create_offers_items_infos_table', 12);
...
(1, 4, 3, 'تم الرد علي الطلب الذي رقمه 2 من قبل الادارة ', 'Admin reply to request number 2 please check this ', '', 1, '2022-12-13 14:07:35', '2023-02-25 04:43:46'),
...
(4, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(5, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(6, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(7, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(8, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(9, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(10, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(11, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:17:42'),
(12, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-01-25 14:46:12'),
(13, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(14, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(15, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(16, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(17, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(18, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(19, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(20, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(21, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(22, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(23, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(24, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(25, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(26, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(27, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:10:53'),
(28, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:21:17'),
(29, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(30, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(31, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(32, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(33, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(34, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(35, 3, 4, 'test', 'test', '', 1, '2022-12-22 18:05:12', '2023-02-25 04:23:28'),
(36, 7, 2, 'تم تعديل الطلب الذي رقمه 34 تعديل رقم القطعه : 11-22-33-44', 'order request has been updated 34 with part number : 11-22-33-44', '', 1, '2022-12-22 20:33:41', '2023-02-25 04:23:28'),
...
(42, 4, 7, 'تم تغيير حاله طلب رقم 34 بنجاح ', 'request number 34 status has been updated successfully', '', 1, '2022-12-22 21:06:04', '2023-02-25 04:24:56'),
(43, 7, 2, 'تم تعديل الطلب الذي رقمه 35 تعديل رقم القطعه : 11-22-33-44', 'order request has been updated 35 with part number : 11-22-33-44', '', 1, '2022-12-22 21:37:11', '2023-02-25 04:23:28'),
(44, 4, 7, 'تم الرد علي الطلب الذي رقمه 35 من قبل الادارة ', 'Admin reply to request number 35 please check this ', '', 1, '2022-12-22 21:39:41', '2023-02-25 04:24:56'),
(45, 4, 7, 'تم تغيير حاله طلب رقم 35 بنجاح ', 'request number 35 status has been updated successfully', '', 1, '2022-12-22 21:42:52', '2023-02-25 04:24:56'),
(46, 7, 2, 'تم تعديل الطلب الذي رقمه 42 تعديل رقم القطعه : 11-22-33-44', 'order request has been updated 42 with part number : 11-22-33-44', '', 1, '2022-12-27 15:00:57', '2023-02-25 04:23:28'),
(47, 4, 7, 'تم الرد علي الطلب الذي رقمه 42 من قبل الادارة ', 'Admin reply to request number 42 please check this ', '', 1, '2022-12-27 15:15:14', '2023-02-25 04:24:56'),
(48, 4, 7, 'تم تغيير حاله طلب رقم 42 بنجاح ', 'request number 42 status has been updated successfully', '', 1, '2022-12-27 15:27:01', '2023-02-25 04:24:56'),
(49, 4, 7, 'تم الرد علي الطلب الذي رقمه 49 من قبل الادارة ', 'Admin reply to request number 49 please check this ', '', 1, '2023-01-11 15:57:34', '2023-02-25 04:24:56'),
(50, 4, 7, 'تم تغيير حاله طلب رقم 49 بنجاح ', 'request number 49 status has been updated successfully', '', 1, '2023-01-11 16:06:52', '2023-02-25 04:24:56'),
(51, 4, 7, 'تم الرد علي الطلب الذي رقمه 50 من قبل الادارة ', 'Admin reply to request number 50 please check this ', '', 1, '2023-01-11 16:21:26', '2023-02-25 04:24:56'),
(52, 4, 7, 'تم تغيير حاله طلب رقم 50 بنجاح ', 'request number 50 status has been updated successfully', '', 1, '2023-01-11 16:34:15', '2023-02-25 04:24:56'),
(53, 4, 7, 'تم الرد علي الطلب الذي رقمه 55 من قبل الادارة ', 'Admin reply to request number 55 please check this ', '', 1, '2023-02-01 21:05:23', '2023-02-25 04:24:56'),
(54, 4, 7, 'تم الرد علي الطلب الذي رقمه 55 من قبل الادارة ', 'Admin reply to request number 55 please check this ', '', 1, '2023-02-01 21:05:55', '2023-02-25 04:24:56'),
(55, 13, 7, 'تم الرد علي الطلب الذي رقمه 55 من قبل الادارة ', 'Admin reply to request number 55 please check this ', '', 1, '2023-02-24 14:21:10', '2023-02-25 04:24:56'),
(56, 4, 13, 'تم ارسال لك طلب من الاداره برجاء قرائته وارفاق ملف الاكسل الذي يحتوي علي التسعيرات الخاصه بك', 'A request has been sent to you from the administration. Please read it and attach the excel file that contains your pricing.', '', 1, '2023-02-25 03:33:16', '2023-02-25 03:33:31'),
(57, 13, 2, 'تم الرد علي الطلب الذي رقمه 56', 'request number 56 has been replied please check this ', '', 1, '2023-02-25 03:57:48', '2023-02-25 04:23:28'),
(58, 13, 2, 'تم الرد علي الطلب الذي رقمه 56', 'request number 56 has been replied please check this ', '', 1, '2023-02-25 04:23:07', '2023-02-25 04:23:28'),
(59, 4, 3, 'تم ارسال لك طلب من الاداره برجاء قرائته وارفاق ملف الاكسل الذي يحتوي علي التسعيرات الخاصه بك', 'A request has been sent to you from the administration. Please read it and attach the excel file that contains your pricing.', '', 1, '2023-02-25 04:43:00', '2023-02-25 04:43:46'),
(60, 3, 2, 'تم الرد علي الطلب الذي رقمه 56', 'request number 56 has been replied please check this ', '', 0, '2023-02-25 04:50:57', '2023-02-25 04:50:57'),
(61, 4, 7, 'تم الرد علي الطلب الذي رقمه 56', 'request number 56 has been replied please check this ', '', 0, '2023-02-25 04:52:47', '2023-02-25 04:52:47'),
(62, 4, 7, 'تم تغيير حاله طلب رقم 56 بنجاح ', 'request number 56 status has been updated successfully', '', 0, '2023-02-25 04:53:48', '2023-02-25 04:53:48');
...
INSERT INTO `offers` (`id`, `user_id`, `brand_id`, `start_date`, `end_date`, `created_at`, `updated_at`) VALUES
(1, 3, 1, '2023-02-03', '2024-01-01', '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(2, 13, 2, '2023-01-01', '2025-01-01', '2023-02-26 05:24:15', '2023-02-26 05:24:15');

-- --------------------------------------------------------

--
-- Table structure for table `offers_items_infos`
--

CREATE TABLE `offers_items_infos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `offer_id` bigint(20) UNSIGNED NOT NULL,
  `item_info_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `offers_items_infos`
--

INSERT INTO `offers_items_infos` (`id`, `offer_id`, `item_info_id`, `created_at`, `updated_at`) VALUES
(1, 1, 41, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(2, 1, 42, '2023-02-26 04:37:49', '2023-02-26 04:37:49'),
(3, 2, 43, '2023-02-26 05:24:15', '2023-02-26 05:24:15'),
(4, 2, 44, '2023-02-26 05:24:15', '2023-02-26 05:24:15');
...
(9, 'الدول', 'countries', 'ri-map-pin-line', '2023-02-22 21:56:48', NULL),
(10, 'العروض', 'offers', 'ri-percent-line', '2023-02-26 04:41:28', NULL);
...
(77, 52, 1, '11-22-33-44', 10, NULL, '2023-02-01 20:47:17', '2023-02-01 20:47:17'),
(78, 52, 1, '44-11-aa-gg-33', 20, NULL, '2023-02-01 20:47:17', '2023-02-01 20:47:17'),
(79, 54, 1, '11-22-33-44', 10, NULL, '2023-02-01 20:47:57', '2023-02-01 20:47:57'),
(80, 54, 1, '44-11-aa-gg-33', 20, NULL, '2023-02-01 20:47:57', '2023-02-01 20:47:57'),
(81, 55, 1, '11-22-33-44', 10, NULL, '2023-02-01 20:48:46', '2023-02-01 20:48:46'),
(82, 55, 1, '44-11-aa-gg-33', 20, NULL, '2023-02-01 20:48:46', '2023-02-01 20:48:46'),
(83, 56, 1, '11-22-33-44', 10, NULL, '2023-02-25 03:21:44', '2023-02-25 03:21:44'),
(84, 56, 1, '44-11-aa-gg-33', 20, NULL, '2023-02-25 03:21:44', '2023-02-25 03:21:44');
...
(52, 7, 0, 25.5, '2023-02-01 20:47:17', '2023-02-01 20:47:17'),
(54, 7, 0, 25.5, '2023-02-01 20:47:57', '2023-02-01 20:47:57'),
(55, 7, 1, 25.5, '2023-02-01 20:48:46', '2023-02-01 21:05:23'),
(56, 7, 3, 25.5, '2023-02-25 03:21:43', '2023-02-25 04:53:48');
...
(6, 56, '16773080021628595168694_image.png', '2023-02-25 04:53:22', '2023-02-25 04:53:22');
...
(5, 'supervisor', '2023-01-30 22:32:40', NULL);
...
(1, 25.50, '2023-01-05 15:08:33', '2023-01-30 00:31:28');
...
INSERT INTO `users` (`id`, `role_id`, `username`, `email`, `email_verified_at`, `serial_number`, `password`, `phone`, `country_id`, `image`, `approved`, `wallet`, `remember_token`, `created_at`, `updated_at`) VALUES
(2, 1, 'احمد حسن', 'alyaa@yahoo.com', NULL, '', '$2y$10$TZPgw.sBqDwjydK5t07h7ucEqHCtkg3DCQX0mmwCPZQOVVp8CgCtW', '3123123111', 1, 'default.png', 0, 0, NULL, '2022-10-08 17:54:59', '2022-10-08 17:54:59'),
(3, 2, 'ابراهيم مصطفي', 'ibrahim@yahoo.com', NULL, '', '$2y$10$UMhuogVb8pYciodY3tRI3OPGapowchh3GUaMh3qUXjzZXsNNFs/pm', '1231231234', 1, 'default.png', 0, 0, NULL, '2022-10-11 17:07:18', '2022-10-11 17:07:18'),
(4, 1, 'محمد عل', 'mahmoud_elzanklony@yahoo.com', NULL, '', '$2y$10$O5yDqEiKcKOQ0izdTNJG0.Wd5d90Xsd73CHAQxMY4PoYa93XW8.r2', '01005663932', 1, 'default.png', 0, 0, NULL, '2022-10-24 20:29:16', '2023-01-30 18:33:32'),
(5, 3, 'اسماء علي', 'asmaa@yahoo.com', NULL, '', '$2y$10$l4IWerbQVSbSVt5g75JmTuXpnYaE9Px9gjOyHPlygCWXDoPpCdVfG', '01005663932', 1, 'default.png', 0, 0, NULL, '2022-11-05 18:21:30', '2022-11-05 18:21:30'),
(6, 3, 'reem yehia', 'reem@yahoo.com', NULL, '', '$2y$10$uPrn54aTQ51R3c9XnSWCGOc4T7f5jTMhaArhDDmdNR08ZZ1WNZXYO', '01005663932', 1, 'default.png', 0, 0, NULL, '2022-12-03 15:37:39', '2023-01-01 19:43:20'),
(7, 3, 'محمود علي', 'nada@yahoo.com', NULL, '', '$2y$10$d4icemQk6HepVJLP8KjJsOykqMcepMGqDaJYHFDYXZiWFbDKyrPAe', '0100123123', 1, '16741542159167575614792_image.jpg', 1, 0, NULL, '2022-12-06 20:05:12', '2023-02-01 20:46:41'),
(9, 3, NULL, 'khaled@yahoo.com', NULL, '', '$2y$10$9zhZcS50p6fM7plreuWow.eqOmyL16yPuxwlXIai8oy/yb5fGnanW', '011522966412', 1, 'default.png', 0, 0, NULL, '2023-01-01 18:19:59', '2023-01-01 18:20:36'),
(10, 5, 'محمد حسن', 'mohamed_hassan@yahoo.com', NULL, '3213123', '$2y$10$v.2b1KXOb04/cMorC1dxreVWaqlZcNZOSQgkBF1uKW1m4UImKZ2De', '0115229312312', 1, 'default.png', 1, 0, NULL, NULL, '2023-02-04 19:50:46'),
(12, 3, NULL, 'hoda19972016@gmail.com', NULL, '', '$2y$10$7rP5r/9..dS9GEZF7lmK6.V9JNTHRb4ChQbDglP4o1j5cIW71bnlq', '010032133123123', 1, 'default.png', 0, 0, NULL, '2023-02-13 00:07:35', '2023-02-13 00:07:35'),
(13, 2, 'مورد قطع', 'seller@yahoo.com', NULL, '', '$2y$10$LVuBg9ZjrrWcjWcTa0hu4OwTCGDOHFUmKBd55kOshB9Yh0tcAZdxG', '0115223123', 1, 'default.png', 1, 0, NULL, '2023-02-18 18:54:12', '2023-02-18 19:04:20'),
(14, 3, 'mahmoud_elzanklony@yahoo.com', 'saad_ali@yahoo.com', NULL, '', '$2y$10$aDmTl8oFzWrGcWwOOcPbBOSqLWJ38f3rHF4yVV5AjToJbLmjB5BN6', '1090576399', 2, 'default.png', 0, 0, NULL, '2023-02-22 21:15:52', '2023-02-25 05:08:15');
...
(1, 4, 1, '2023-01-30 20:52:42', NULL),
(2, 4, 2, '2023-01-30 20:52:42', NULL),
(3, 4, 3, '2023-01-30 20:52:42', NULL),
(5, 4, 4, '2023-01-30 20:52:42', NULL),
(6, 4, 5, '2023-01-30 20:52:42', NULL),
(7, 4, 6, '2023-01-30 20:52:42', NULL),
(8, 4, 7, '2023-01-30 20:52:42', NULL),
(9, 4, 8, '2023-01-30 20:52:42', NULL),
(30, 10, 3, '2023-02-04 20:20:58', '2023-02-04 20:20:58'),
(31, 10, 5, '2023-02-04 20:20:58', '2023-02-04 20:20:58'),
(32, 10, 7, '2023-02-04 20:20:58', '2023-02-04 20:20:58'),
(33, 10, 8, '2023-02-04 20:20:58', '2023-02-04 20:20:58'),
(34, 4, 9, '2023-02-22 21:58:08', NULL),
(35, 4, 10, '2023-02-26 04:42:55', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `vendors_requests`
--

CREATE TABLE `vendors_requests` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `quotation_order_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `vendors_requests`
--

INSERT INTO `vendors_requests` (`id`, `user_id`, `quotation_order_id`, `created_at`, `updated_at`) VALUES
(1, 13, 55, '2023-02-24 04:33:56', NULL),
(6, 13, 56, '2023-02-25 03:33:16', '2023-02-25 03:33:16'),
(7, 3, 56, '2023-02-25 04:43:00', '2023-02-25 04:43:00');
...
--
-- Indexes for table `offers_items_infos`
--
ALTER TABLE `offers_items_infos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `offers_items_infos_offer_id_foreign` (`offer_id`),
  ADD KEY `offers_items_infos_item_info_id_foreign` (`item_info_id`);
...
ALTER TABLE `users_privillages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `users_privillages_user_id_foreign` (`user_id`),
  ADD KEY `users_privillages_privillage_id_foreign` (`privillage_id`);

--
-- Indexes for table `vendors_requests`
--
ALTER TABLE `vendors_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vendors_requests_user_id_foreign` (`user_id`),
  ADD KEY `vendors_requests_quotation_order_id_foreign` (`quotation_order_id`);
...
--
-- AUTO_INCREMENT for table `offers_items_infos`
--
ALTER TABLE `offers_items_infos`
...
--
-- AUTO_INCREMENT for table `vendors_requests`
--
ALTER TABLE `vendors_requests`
...
ALTER TABLE `items_infos`
  ...
  ADD CONSTRAINT `items_infos_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `offers`
  ADD CONSTRAINT `offers_brand_id_foreign` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `offers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `offers_items_infos`
--
ALTER TABLE `offers_items_infos`
  ADD CONSTRAINT `offers_items_infos_item_info_id_foreign` FOREIGN KEY (`item_info_id`) REFERENCES `items_infos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `offers_items_infos_offer_id_foreign` FOREIGN KEY (`offer_id`) REFERENCES `offers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `users_privillages`
  ADD CONSTRAINT `users_privillages_privillage_id_foreign` FOREIGN KEY (`privillage_id`) REFERENCES `privillages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `users_privillages_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `vendors_requests`
--
ALTER TABLE `vendors_requests`
  ADD CONSTRAINT `vendors_requests_quotation_order_id_foreign` FOREIGN KEY (`quotation_order_id`) REFERENCES `quotation_orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `vendors_requests_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
