        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              item = component.get_obj_wanted($(this).attr('el_id'));
              _context3.next = 3;
              return component.send_agreement_to_admin(item);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                ...
                total = 0;
                _iterator = _createForOfIteratorHelper($('#print_box table tr:not(:first-of-type,:last-of-type) td:last-of-type'));
    ...
    jQuery(document).ready(function ($) {
      ...
      data_table = $('.myTableServer').DataTable({
        ...
        createdRow: function createdRow(row, data, dataIndex) {
          if (data.hasOwnProperty('is_completed') && data.is_completed) $(row).find('span[name="order"]').html(dataIndex + 1);
