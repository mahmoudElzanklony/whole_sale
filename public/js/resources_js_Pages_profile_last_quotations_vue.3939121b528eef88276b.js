...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "render": function render(data, type, row, option) {
        if (row['is_completed'] == 0) {
          ...
          return '<span class="print" el_id="' + row['id'] + '"><i class="ri-printer-line"></i></span>';
        } else {
          return '';
        }
      }
    ...
    $('.content').on('click', '.data table tbody tr td.actions button.agree_request', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
      var item;
