...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "data": "is_completed",
      "render": function render(data, type, row) {
        return row['is_completed'] == 0 ? component.switchWord('sent_to_admin') : row['is_completed'] == 11 ? component.switchWord('in_progress') : row['is_completed'] == 1 ? component.keywords.wait_client_to_confirm : row['is_completed'] == 2 ? component.keywords.order_confirmed : component.keywords.complete_request_successfully;
      }
    }, {
      "data": "id",
      // get my quotation
    ...
    $('.content').on('click', '.data table tbody tr td.actions button.agree_request,.data table tbody tr td.actions .receipt', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
      var item, error, part_numbers, interval;
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_10__.mapActions)({
    ...
    print_bill: function () {
      var _print_bill = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee10(i) {
        var total, _iterator3, _step3, price;
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                ...
                total = 0;
                _iterator3 = _createForOfIteratorHelper($('#print_box table tr:not(:first-of-type,:last-of-type,.tax_row) td:last-of-type'));
  ...
  mounted: function mounted() {
    ...
    var _iterator4 = _createForOfIteratorHelper(all_thead_tds),
        _step4;
                          ...
                          [
                            _c("thead", [
                              _c("tr", [
                                ...
                                _vm._v(" "),
                                _c("td", [
                                  _vm._v(_vm._s(_vm.keywords.unit_price)),
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  _vm._v(
