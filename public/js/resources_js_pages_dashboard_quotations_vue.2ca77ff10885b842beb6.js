  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "render": function render(data, type, row, option) {
        ...
        if (row['is_completed'] != 3) {
          output += '<span class="delete" style="color:darkred;" title="' + component.switchWord('cancel_request') + '"  el_id="' + row['id'] + '"><i class="ri-delete-back-line"></i></span>';
        }
    ...
    $('.content').on('click', '.data table tbody tr td:last-of-type span:last-of-type', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee10() {
      var item;
