  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "render": function render(data, type, row, option) {
        return '<span><i class="ri-upload-2-line" el_id="' + row['id'] + '"></i> </span><span class="receipt" el_id="' + row['id'] + '"><i class="ri-image-line"></i></span><span class="repositry_upload" el_id="' + row['id'] + '"><i class="ri-file-paper-line"></i></span><span class="delete" el_id="' + row['id'] + '"><i class="ri-close-line"></i></span>';
      }
    }]; // add events
    // export file
