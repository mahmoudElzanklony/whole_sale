...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "data": "is_completed",
      "render": function render(data, type, row) {
        return row['is_completed'] == 0 ? component.switchWord('sent_to_admin') : row['is_completed'] == 1 ? component.keywords.reply_from_admin : row['is_completed'] == -1 ? '<span>' + component.switchWord('cancel_done') + '</span>' + '<span class="cancel_info_icon" title="' + component.handling_data.reasons.find(function (e) {
