  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "render": function render(data, type, row) {
        ...
        })['name'] + '"><i class="ri ri-information-line"></i></span>' : row['is_completed'] == 11 ? component.switchWord('vendors_reply') : row['is_completed'] == 2 ? '<button el_id="' + row['id'] + '" class="confirm btn btn-outline-primary">' + component.keywords.click_here_to_finish_request + '</button>' : component.switchWord('order_confirmed');
      }
    }, {
      "data": "id",
      // get my quotation
