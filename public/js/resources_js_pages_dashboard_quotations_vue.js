...
/* harmony import */ var _mixin_detect_right_part_name__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../mixin/detect_right_part_name */ "./resources/js/mixin/detect_right_part_name.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "data": "is_completed",
      "render": function render(data, type, row) {
        return row['is_completed'] == 0 && row['vendors_requests_count'] == 0 ? component.switchWord('sent_to_admin') : row['is_completed'] == 0 && row['vendors_requests_count'] > 0 ? component.switchWord('sent_to_vendors') : row['is_completed'] == 1 ? component.keywords.reply_from_admin : row['is_completed'] == -1 ? '<span>' + component.switchWord('cancel_done') + '</span>' + '<span class="cancel_info_icon" title="' + component.handling_data.reasons.find(function (e) {
          return e['id'] == row['cancelled_quotations']['cancelled_id'];
        })['name'] + '"><i class="ri ri-information-line"></i></span>' : row['is_completed'] == 11 ? component.switchWord('vendors_reply') : row['is_completed'] == 2 && row['my_receipt_count'] > 0 ? '<button el_id="' + row['id'] + '" class="confirm btn btn-outline-primary">' + component.keywords.click_here_to_finish_request + '</button>' : row['is_completed'] == 2 && row['my_receipt_count'] == 0 ? component.switchWord('wait_receipt') : component.switchWord('order_confirmed');
      }
    }, {
      "data": "id",
      // get my quotation
  ...
  methods: _objectSpread(_objectSpread({
    ...
    detect_right_price: function detect_right_price(i) {
      var d = this.admin_quotation.find(function (e) {
        ...
        return e['part_number'] == (i['last_draft'].length == 0 ? i['part_number'] : i['last_draft'][0]['part_number']);
      });
    ...
    print_bill: function () {
      var _print_bill = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee11(i) {
              ...
              case 3:
                ...
                for (data_item_index in this.get_my_quotation) {
                  ...
                  if (isNaN(this.detect_right_price(this.get_my_quotation[data_item_index]))) {
                    ...
                    result = Number(this.detect_right_price(this.get_my_quotation[data_item_index]) * (this.get_my_quotation[data_item_index]['last_draft'].length == 0 ? this.get_my_quotation[data_item_index]['quantity'] : this.get_my_quotation[data_item_index]['last_draft'][0]['quantity'])).toFixed(2);
                  }
                ...
                $('#print_box table tr.tax_row td:last-of-type').html(Number(total * Number(this.item.tax) / 100).toFixed(2));
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".alert-danger[data-v-bcc89aaa] {\n  display: none;\n}\n#update_quotations .modal-dialog[data-v-bcc89aaa] {\n  width: 70%;\n  max-width: 900px;\n}\n.loading-img[data-v-bcc89aaa] {\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  background-color: white;\n  text-align: center;\n  margin: auto;\n  display: none;\n  height: 380px;\n}\ntable tr td p[data-v-bcc89aaa] {\n  text-align: center;\n}\ntable tr td p button[data-v-bcc89aaa] {\n  border: none;\n  outline: none;\n  background-color: transparent;\n  color: #035397;\n}\n#my_quotations .modal-dialog[data-v-bcc89aaa],\n#old_update .modal-dialog[data-v-bcc89aaa],\n#see_prices .modal-dialog[data-v-bcc89aaa],\n#admin_quotation_data .modal-dialog[data-v-bcc89aaa] {\n  max-width: 1100px;\n}\n@media print {\nbody *[data-v-bcc89aaa] {\n    visibility: hidden;\n}\n.content.users.table-data-page[data-v-bcc89aaa] {\n    display: none;\n}\n.inner-profile[data-v-bcc89aaa], nav[data-v-bcc89aaa], footer[data-v-bcc89aaa] {\n    display: none;\n}\n*[data-v-bcc89aaa]:not(td, tr) {\n    top: 0px;\n    margin: 0px;\n    transform: unset;\n    padding: 0px;\n}\n.receipt[data-v-bcc89aaa] {\n    height: auto;\n    display: block;\n}\n.receipt *[data-v-bcc89aaa] {\n    visibility: visible;\n    margin: 0px;\n}\n.receipt button[data-v-bcc89aaa] {\n    visibility: hidden;\n}\n#receipt .modal-footer[data-v-bcc89aaa] {\n    display: none;\n}\n#receipt table tbody tr td[data-v-bcc89aaa] {\n    border: 1px solid #dddddd !important;\n}\n.receipt table tr td[data-v-bcc89aaa] {\n    border: 3px solid #dddddd !important;\n}\n.receipt table:last-of-type tfoot tr:first-of-type td[data-v-bcc89aaa] {\n    border-top: 0px !important;\n}\n#receipt table thead[data-v-bcc89aaa] {\n    position: relative !important;\n    top: 0px !important;\n}\n#receipt table tfoot[data-v-bcc89aaa] {\n    position: unset !important;\n}\n#fb-root[data-v-bcc89aaa] {\n    display: none;\n}\n.modal[data-v-bcc89aaa], #print_box[data-v-bcc89aaa] {\n    position: relative !important;\n    top: 0px !important;\n}\n}\n#print_box > div[data-v-bcc89aaa] {\n  max-width: 900px;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
            ...
            [
              _c("form", [
                _c("p", [
                  ...
                  _vm._v(" "),
                  _c("span", [_vm._v(_vm._s(_vm.switchWord("all")))]),
                ]),
                _vm._v(" "),
                _c("p", [
                  _c("input", {
                ...
                _c("p", [
                  _c("input", {
                    attrs: { type: "radio", name: "is_completed" },
                    domProps: { value: _vm.switchWord("sent_to_vendors") },
                  }),
                  _vm._v(" "),
                  _c("span", [
                    _vm._v(_vm._s(_vm.switchWord("sent_to_vendors"))),
                  ]),
                ]),
                _vm._v(" "),
                _c("p", [
                ...
                _c("p", [
                  _c("input", {
                    attrs: { type: "radio", name: "is_completed" },
                    domProps: { value: _vm.switchWord("cancel_request") },
                  }),
                  _vm._v(" "),
                  _c("span", [
                    _vm._v(_vm._s(_vm.switchWord("cancelled_requests"))),
                  ]),
                ]),
                _vm._v(" "),
                _c("p", [
                      ...
                      _vm.item != null
                        ? _c(
                            "a",
                            {
                              ...
                              attrs: {
                                href:
                                  "/quotations/export-file?" +
                                  (_vm.item.hasOwnProperty("offer") &&
                                  _vm.item["offer"] != null
                                    ? "offer=true&"
                                    : "") +
                                  "ids=" +
                              ...
                              ? _c("div", [
                                  ...
                                  _c("p", [
                                    _c(
                                      ...
                                      [
                                        _vm._v(
                                          _vm._s(_vm.switchWord("tax_number"))
                                        ),
                                      ]
                                    ),
                                    _vm._v(" : "),
