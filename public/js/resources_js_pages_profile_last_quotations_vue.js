  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "render": function render(data, type, row) {
        ...
        })['name'] + '"><i class="ri ri-information-line"></i></span>' : row['is_completed'] == 1 ? component.keywords.wait_client_to_confirm : row['is_completed'] == 2 ? component.keywords.order_confirmed : component.keywords.complete_request_successfully;
      }
    }, {
      "data": "id",
      // get my quotation
                  ...
                  _c("div", { staticClass: "modal-content" }, [
                    _c("div", { staticClass: "modal-header" }, [
                      _c(
                        ...
                        [
                          _vm.item["is_completed"] == 3
                            ? _c("span", [
                                _vm._v(_vm._s(_vm.switchWord("tax_bill"))),
                              ])
                            : _c("span", [
                                _vm._v(_vm._s(_vm.switchWord("initial_bill"))),
                              ]),
                        ]
                      ),
                      _vm._v(" "),
                  ...
                  ? _c("div", { staticClass: "modal-body" }, [
                      ...
                      _c(
                        "button",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              return _vm.print_bill(_vm.item)
                            },
                          },
                        },
                        [
