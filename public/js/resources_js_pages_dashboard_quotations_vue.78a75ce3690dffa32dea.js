...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.table_columns = [{
      ...
      "data": "is_completed",
      "render": function render(data, type, row) {
        return row['is_completed'] == 0 ? component.switchWord('sent_to_admin') : row['is_completed'] == 1 ? component.keywords.reply_from_admin : row['is_completed'] == -1 ? component.switchWord('cancel_done') : row['is_completed'] == 11 ? component.switchWord('vendors_reply') : row['is_completed'] == 2 ? '<button el_id="' + row['id'] + '" class="confirm btn btn-outline-primary">' + component.keywords.click_here_to_finish_request + '</button>' : component.switchWord('order_confirmed');
      }
    }, {
      "data": "id",
      // get my quotation
            ...
            [
              _c("form", [
                ...
                _c("p", [
                  ...
                  _vm._v(" "),
                  _c("span", [
                    _vm._v(_vm._s(_vm.switchWord("cancel_request"))),
                  ]),
                ]),
                _vm._v(" "),
                _c("p", [
