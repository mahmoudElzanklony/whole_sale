            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" v-if="item != null">
                        ...
                        <img if="get_receipt.hasOwnProperty('image')"
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr v-for="(i,index) in get_my_quotation"
                                    ...
                                    <td>
                                        ...
                                        {{ switchWord('parts_from') }}
                                        <strong>{{
                                                i['last_draft'].length == 0 ? i['part_number']:
                                ...
                                <tr class="tax_row">
                                    <td colspan="2">{{ keywords.tax }}</td>
                                    <td>{{ item.tax }}%</td>
                                </tr>
                                <tr>
                                    <td colspan="2">{{ keywords.total }}</td>
                                    <td></td>
                                </tr>
                                </tbody>
                            </table>
