                    ...
                    <table class="myTable table text-center table-bordered table-striped table-hover">
                        ...
                        <tr v-for="(i,index) in vuex_data"
                            ...
                            <td class="actions">
                                ...
                                <span class="delete" @click="delete_item('countries',i['id'],'.row_'+index)"><i class="ri-close-line"></i></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" @submit.prevent="save_country">
                            ...
                            <div class="form-group"
                                ...
                                <input :name="input" class="form-control"
                                       :value="item != null ? item[input]:''" :required="input.indexOf('info') == -1">
