...
<head>
    ...
    <link href="{{ mix('/css/app.css') }}?version=35.12" rel="stylesheet" />
    @if(session()->get('lang') == 'en' || session()->get('lang') == 'tu')
        <link href="{{ mix('/css/english.css') }}?v=35.4" rel="stylesheet" />
    @else
    ...
    <script src="{{ mix('/js/app.js') }}?v=97.33.7" defer></script>
    <style>
        /*body{
            overflow: hidden;
        }
